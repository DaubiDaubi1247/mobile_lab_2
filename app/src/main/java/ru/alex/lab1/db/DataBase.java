...
public class DataBase {
    private final Map<Integer, MonsterWithDescriptionDto> monsterDb;
    ...
    public MonsterWithDescriptionDto getMonsterById(int id) {
        return monsterDb.get(id);
    }

    private void setInitialData() {
        MonsterWithDescriptionDto monsterDto = new MonsterWithDescriptionDto(R.drawable.vampire, "Вампиры",
        ...
        monsterDto = new MonsterWithDescriptionDto(R.drawable.ghost, "Духи и призраки",
        ...
        monsterDto = new MonsterWithDescriptionDto(R.drawable.draconid, "Дракониды",
        ...
        monsterDto = new MonsterWithDescriptionDto(R.drawable.relict, "Реликты",
        ...
        monsterDto = new MonsterWithDescriptionDto(R.drawable.ogr, "Огры",
        ...
        monsterDto = new MonsterWithDescriptionDto(R.drawable.gibrid, "Гибриды",
